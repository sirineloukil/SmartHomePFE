...
public class UserController {
    ...
    public List<User> getAllUsers(Authentication authentication) {
        ...
        KeycloakAuthenticationToken keuAuth = (KeycloakAuthenticationToken)authentication;
        KeycloakPrincipal<RefreshableKeycloakSecurityContext> principal = (KeycloakPrincipal<RefreshableKeycloakSecurityContext>) keuAuth.getPrincipal();
        principal.getKeycloakSecurityContext().getToken().getName();
